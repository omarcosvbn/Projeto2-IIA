...
public abstract class SampleControllerBase : MonoBehaviour {
    ...
    private void UpdateStatistics()
    {
        ...
        string generationInfo = $"{GA.GenerationsNumber};{m_previousBestFitness};{m_previousAverageFitness};{best.NumberOfWheels};{best.CarMass};{best.RoadCompleted};{best.Distance};{best.EllapsedTime};{best.SumVelocities};{best.SumAccelerations};{best.SumForces}" + Environment.NewLine;

        if (!File.Exists(pathToFile))
        {
            string header = "Generation;BestFitness;AverageFitnessPopulation;BestNumberOfWheels;BestCarMass;BestRoadCompleted;BestDistance;BestEllapsedTime;BestSumVelocities;BestSumAccelerations;BestSumForces" + Environment.NewLine;
    ...
    private void DumpBest(int generationsNumber)
    {
